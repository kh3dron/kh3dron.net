---
title: "My Coding Setup, March 2026"
date: "March 11, 2026"
---
...
I like things very clean and very simple. As few things as possible on the screen at once. I try to transfer that to my writing. Practicing that. To borrow a phrase: if you're not occasionally re-surfacing elements that you previously hid, you're not hiding enough.

# Physical

## Laptop only, no monitors

Mostly because of AeroSpace, but I don't use an external monitor. I've gone through lots of setups in the past: 2x1080p, then 2x4k, ultrawide, then 1x 4k, now back to just the laptop. I only ever have window open on the screen at a time, no split screens, no split terminals or editors. A 15-inch laptop is plenty. It also gives me more mobility; I can lounge around and be 100% comfortable on a couch, in a hotel room, or moving between conference rooms.
...
![My desk facing the window](desk.jpeg "Desk")

![Squirrels at the birdfeeder](squirrels.jpeg "Squirrels")

## Mechanical keyboard on the laptop

I use a 75% keyboard, a Keychron K3. It's either on top of my MacBook Pro keyboard or on my bookshelf desk. It's a little silly to carry around and set up on top of my laptop, and I've tried not doing this, but it relly just feels much nicer to use. I like the K2 because it's simple, low profile, and has no bezel. I had a wacky Voyager split keyboard for a while, I used it for about three months, but I was just so annoyed at having to learn how to type again that I gave up. My typing speed is about 130 WPM on a normal keyboard, and I peaked at ~100 after 3 months on the voyager.
...
![Standing bookshelf desk and proper desk](shelf.jpeg "Office")

# Applications

## WezTerm

WezTerm is nice. Very extensible, configs are easy to change, and that's about it. I keep the terminal background mostly transparent, which makes the colors pop, and I like my wallpapers and want to see them. wallpapers are typically dark, mostly monochrome. I've got about 300 in a folder and change them one every couple weeks to shake things up.
...
![My wezterm config](wez.png "Wezterm config")

![Custom markdown syntax colors](markdown.png "Markdown colors")
